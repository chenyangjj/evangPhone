...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("EvangSol.Mobibrary.Platforms.Android.AutoCustomFilter, EvangMobibrary", AutoCustomFilter.class, __md_methods);
	}

	public AutoCustomFilter ()
	{
		super ();
		if (getClass () == AutoCustomFilter.class) {
			mono.android.TypeManager.Activate ("EvangSol.Mobibrary.Platforms.Android.AutoCustomFilter, EvangMobibrary", "", this, new java.lang.Object[] {  });
		}
	}
